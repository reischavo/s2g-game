...
(function() {
    ...
    if (typeof io === 'undefined') {
        console.error('❌ Socket.IO kütüphanesi yüklenmedi!');
        return;
    }
        ...
        async function sendMessage() {
            ...
            try {
                ...
                if (!result.success) {
                    ...
                    // Hata mesajı göster
                    addMessage('Mesaj gönderilemedi. Lütfen tekrar deneyin.', 'system');
                }
            } catch (error) {
                console.error('❌ Fetch error:', error);
                addMessage('Bağlantı hatası. Lütfen tekrar deneyin.', 'system');
            }
        }
